...
public:
     ...
     * The bounding box is created taking into account all the children
     * GameObject%s.
     ...
     * If this Transform does not have a parent this is equivalent to
     * setPosition()
     ...
     * The returned GameObjectEH is not valid if no GameObject can be found
     * using that path.
     * @param a relative path starting from the current node
     * @return a GameObjectEH to the found GameObject (invalid if no GameObject
     * is found)
     */
