...
public:
     ...
     * A higher value can be used in conjunction with a lower kernel size but
     * the result might be a nosier.
    ...
    /**
     * Sets the blur size.
     * To achieve a more realistic result, a blur effect is applied to the
     * ambient occlusion. The size of the blur effect determines how blurry the
     * occlusion will be.
