...
public:
	...
	/** The light casting god rays is represented by a sphere, this is its radius */
	float lightRadius = 0.5f;

	/**
	 * Creates a new GodRays effect.
	 * The scale factor determines the size (with respect to the resolution of the screen) of
	 * the texture on which the effect created. A scaleFactor near 1.0 will create a good quality
	 * effect but it may impact performances.
