...
public:
	...
	/** The min value for a particle position (relative to the ParticleEmitter position)  */
	glm::vec3 positionOffsetMin{ 0, 0, 0 };
	/** The min value for a particle position (relative to the ParticleEmitter position)  */
	glm::vec3 positionOffsetMax{ 0, 0, 0 };

	/** If true, velocityMin and velocityMax are rotated according to their emitter */
