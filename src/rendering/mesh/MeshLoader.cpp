...
MeshLoader::MeshLoader(GLenum drawMode)
    : mDrawMode{ drawMode }
    , mVao{ 0 } {
...
Mesh MeshLoader::createMesh(const float vertexData[],
    ...
    glBufferData(
        GL_ARRAY_BUFFER, 11 * numOfVertices * sizeof(float), static_cast<const void*>(vertexData), GL_STATIC_DRAW);
