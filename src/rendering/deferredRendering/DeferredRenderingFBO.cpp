...
void DeferredRenderingFBO::init(std::uint32_t width, std::uint32_t height) {
    ...
    mAdditionalBuffer = Texture::load(nullptr, width, height, DIFFUSE_BUFFER_SETTINGS);
    mPositionBuffer = Texture::load(nullptr, width, height, DIFFUSE_BUFFER_SETTINGS);
    mNormalBuffer = Texture::load(nullptr, width, height, DIFFUSE_BUFFER_SETTINGS);
...
std::uint32_t DeferredRenderingFBO::getFBO() const { return mFbo; }
...
const Texture& DeferredRenderingFBO::getDiffuseBuffer() const { return mDiffuseBuffer; }

const Texture& DeferredRenderingFBO::getAdditionalBuffer() const { return mAdditionalBuffer; }

const Texture& DeferredRenderingFBO::getPositionBuffer() const { return mPositionBuffer; }

const Texture& DeferredRenderingFBO::getNormalBuffer() const { return mNormalBuffer; }

const Texture& DeferredRenderingFBO::getDepthBuffer() const { return mDepthBuffer; }

std::uint32_t DeferredRenderingFBO::getWidth() const { return mWidth; }

std::uint32_t DeferredRenderingFBO::getHeight() const { return mHeight; }
...
DeferredRenderingFBO::~DeferredRenderingFBO() { cleanUpIfNeeded(); }
