...
public:
	 ...
	 * The animation won't be played. Use setAndPlayAnimation or playCurrentAnimation
	 ...
	 * @return true if the animation was stopped or paused, false otherwise (even if no current animation is set).
	 */
	bool playCurrentAnimation();

	/**
	 * Pauses the current animation.
	 * @return true if the animation playing, false otherwise (even if no current animation is set).
	 */
	bool pauseCurrentAnimation();

	/**
	 * Stops the current animation.
	 * @return true if the animation playing or paused, false otherwise (even if no current animation is set).
	 */
	bool stopCurrentAnimation();

	/**
	 * @return whether the current animation is playing. false if no current animation is set.
	 */
	bool isCurrentAnimationPlaying() const;

	/**
	 * @return whether the current animation is paused. false if no current animation is set.
	 */
	bool isCurrentAnimationPaused() const;

	/**
	 * @return whether the current animation is stopped. false if no current animation is set.
	 */
	 ...
	 * @return the time of the current animation, 0.f if no animation is set or it is stopped.
	 */
	float getCurrentAnimationTime() const;

	/**
	 * Sets the time of the current animation.
	 * If the current animation was stopped (@see isCurrentAnimationStopped) the animation
	 * will be started an paused.
	 ...
	 */
	const std::string& getCurrentAniamtionName() const {
