...
public:
	 ...
	 * @param boneName2index association between bone names and their indices in skeleton (@see SkeletalAnimationControllerComponent)
	 * @return a SkeletalAnimation. If no animation is contained in the scene the SkeletalAnimation.getDuration will return 0
	 */
	 ...
	 * @param boneName2index association between bone names and their indices in skeleton (@see SkeletalAnimationControllerComponent)
	 * @return a SkeletalAnimation. If no animation is contained in the file the SkeletalAnimation.getDuration will return 0
	 */
